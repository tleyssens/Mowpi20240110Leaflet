...
var mower = require("../lib/MowerLeeg");
...
//var mission = require("./mission");//voor 19/10/2022
let mission = require("./mission20221019"); // vanaf 19/10/2022
var noRTKteller = 0;
let startCounter = 0,
  speedCounter = 0,
  gpsHz = s.gpsHz;
let isFirstFixPositionSet = false,
...
exports.KeyReceived = function (data) { //simulatie 
  switch (data.Key) {
    case "Steering":
