...
exports.KeyReceived = function (data) {
  ...
  switch (data.Key) {
    ...
    case "clickTarget":
      ...
      s.pos.target.lon = data.value.latLng.lng; //traject.push(data.value.latLng);
...
function addDeadZone(value) {
  //middengebied touch minder gevoelig maken
